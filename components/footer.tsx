    ...
    <footer className="bg-foreground text-background py-8 sm:py-10">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-7xl">
        <div className="flex flex-col items-center text-center mb-6">
          ...
          <p className="text-background/80 mb-5 leading-relaxed max-w-2xl text-sm md:text-base">
          ...
          <div className="flex gap-4 sm:gap-5 mb-5">
            <a
              href="#"
              className="w-10 h-10 flex items-center justify-center rounded-full bg-background/10 hover:bg-primary transition-all duration-300 hover:scale-110"
              aria-label="Facebook"
            >
              <svg
                className="w-5 h-5"
